...
namespace TGD.CombatV2
{
    ...
    public sealed class HexClickMover : ActionToolBase, IActionToolV2, IActionExecReportV2, ICooldownKeyProvider, IBindContext
    {
        ...
        PlayerOccupancyBridge PB
        {
            get
            {
                var desired = UnitRuntimeBindingUtil.ResolvePlayerBridge(this, ctx, null, _playerBridge);
        ...
        IGridActor SelfActor
        {
            ...
            {
                var unit = OwnerUnit;
                return UnitRuntimeBindingUtil.ResolveGridActor(unit, _occ, PB);
            }
        }
        ...
        Hex CurrentAnchor
        {
            ...
            {
                var unit = OwnerUnit;
                return UnitRuntimeBindingUtil.ResolveAnchor(unit, _occ, PB);
            }
        }
